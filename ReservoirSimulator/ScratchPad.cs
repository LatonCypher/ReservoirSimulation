namespace ReservoirSimulator
{
    ...
    {
        public ADiff Tr = new(), Er = new(), Oil_Rate = new(), Water_Rate = new(), 
                     DP = new(), Tw = new(), Go_avg = new(), Gw_avg = new();
        ...
        public void ClearMVariables()
        {
            ...
            Oil_Rate.Clear(); Water_Rate.Clear(); Tr.Clear(); DP.Clear(); Tw.Clear(); SoPo_m.Clear(); SwPw_m.Clear(); 
            meanP.Clear(); Er.Clear(); Go_avg.Clear(); Gw_avg.Clear();
        }
